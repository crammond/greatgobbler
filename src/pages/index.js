...
const Index = () => (
	<Layout title="Home">
		<div id="home">
			<div>
				<p style={{color: "red", fontWeight: "bold", fontSize: "2.5rem", margin: 0 }}>Due to the COVID-19 pandemic, the Great Gobbler race is going virtual this year. Click on the "REGISTER" link to register for our virtual Great Gobbler or donate.</p>
